...
require (
	...
	gitlab.kaaiot.net/core/lib/go-config.git v0.0.0-20221021170042-3f91503481c3
	gitlab.kaaiot.net/core/lib/go-metrics.git v0.0.0-20191209075323-8c629fb54438
